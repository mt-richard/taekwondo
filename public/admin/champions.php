...
<div class="md:flex">
    ...
    <main class="w-full px-5 md:px-20 bg-gray-100 ">
        <h2 class="text-xl py-10">Dashbord / Champion</h2>
                        ...
                        <div class="container px-0 mx-auto sm:px-5 bg-white p-5 md:w-1/5 rounded-lg shadow-lg md:mt-20">
                            <div class="md:w-full pb-5">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class=" mb-4 px-3">
                                        <input type="text" required name="name" placeholder="Enter userName" class="w-full  py-1.5 px-6 bg-white outline-none border border-gray-300 rounded ">
                                    </div>
                                    <div class=" mb-4 px-3">
				...
				<?php
                        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
							...
							<tr>
								...
								<td class="px-5 py-1 border-b"><?php echo $user['period']; ?></td>
								<td class="px-5 py-1 border-b"><?php echo $user['award']; ?></td>
								<td class="px-5 py-1 border-b"><?php echo $user['club']; ?></td>
								<td class="px-5 py-1 border-b"><?php echo $user['createdat']; ?></td>
								<td class="px-5 py-1 border-b"><a href="#" class="text-red-600 font-semibold text-[12px]">Delete</a></td>
							</tr>
