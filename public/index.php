...
<!-- home banner -->
<div class="w-full">
    <div id="myDiv" class="w-full mx-auto md:py-40 h-[80vh]">
        <div class="w-full z-10 flex justify-center md:gap-20">
            <div class="md:w-1/3 md:py-10">
                <div>
                    <h4 class="drop-shadow-xl text-white font-bold text-3xl">Welcome to RFT</h4>
                </div>
                <div class="w-full items-center">
                    <h1 class="drop-shadow-xl text-gray-200 font-bold text-6xl py-2">Rwanda TAEKWONDO Federation</h1>
                </div>
                <div class="pb-10">
            ...
            <div class=" relative z-1 md:w-1/5 rounded-t  py-10 mt-40 right-20">
                <h1 class="text-gray-100 py-3 font-bold uppercase text-xl">2023 Champion</h1>
                <h1 class="absolute bg-gray-950 opacity-2 bottom-20 left-0 px-5 flex justify-center text-white py-3 font-bold text-xl uppercase">Cheick Cisse</h1>
...
<div>
    <div class="flex justify-center md:gap-10 md:py-20">
        <div class="md:w-1/5 shadow-xl px-10 py-10 rounded-tl-2xl rounded-br-2xl">
        ...
        <div class="md:w-1/6 px-10 py-10 flex justify-center items-center flex-col">
...
<div class="relative bg-white pt-5">
    <div class="flex flex-col justify-center items-center ">
        <div class="absolute top-0 right-80 bg-gray-950 px-10 py-5">
            <h2 class="uppercase text-white">upcoming event</h2>
        </div>
        <div class="w-3/5 bg-blue-400">
            <div class="flex gap-6 py-5 md:px-10">
                <div class="md:w-1/3">
                    <img src="../assets/images/52222939374_7fb699d8dd_b.jpg" alt="" class="rounded w-full h-full object-cover">
                </div>
                <div class="md:w-2/3"> 
...
<div>
    <div class="flex justify-center md:gap-10 md:py-20 bg-gray-100">
        <div class="md:w-1/3 h-[600px] translate-x-6">
        ...
        <div class="md:w-1/3 flex flex-col justify-center">
            <h1 class="font-bold py-3 text-2xl">Get more info about RTF</h1>
...
<!-- quick review -->
<div>
    <div class="w-full flex gap-2 justify-center bg-gray-950 py-20">
        ...
        <div class="flex gap-6 md:w-1/5 rounded justify-center">
...
<div class="w-full md:py-20">
    ...
    <div class=" flex justify-center gap-5">
        <div class="max-w-sm bg-white drop-shadow-xl newcard">
            <a href="#">
