...
<div>
    <div class="w-full flex flex-col justify-center items-center mb-5 py-10 bg-gray-100 ">
        ...
        <p class="px-5 pb-10 font-light md:w-3/4 lg:w-4/5 xl:w-3/5  text-center"><b>"Meet the Exceptional Champions Who Have Graced Our Journey" </b><br><br>
        ...
        <div class="md:grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 flex-wrap gap-5 justify-center items-center w-full px-5 md:px-10 lg:px-20 xl:px-40">
