    ...
    <div class="bg-gray-100 md:py-10">
        ...
        <div class="w-full flex  justify-center ">
            <div class="md:w-3/5 newslist grid grid-cols-3 gap-5 md:py-10">
                ...
                <div class="max-w-sm bg-white drop-shadow-xl rounded drop-shadow-xl newcard ">
                    <a href="#">
                        <img class="w-full h-60 object-cover" src="../assets/images/1stpressreleasemontreuxphoto.webp" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Best Match for 2021 Competions</h5>
                ...
                <div class="max-w-sm bg-white drop-shadow-xl rounded drop-shadow-xl newcard ">
                    <a href="#">
                        <img class="w-full h-60 object-cover" src="../assets/images/52222939374_7fb699d8dd_b.jpg" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Best Match for 2021 Competions</h5>
